...
#' @param B_LU_BRP (integer)
#' @param D_WP (numeric) The fraction of the parcel that is surrounded by surface water
#' @param D_OPI_SOIL (numeric) the opportunity index 
#' @param D_OPI_WATER (numeric) the opportunity index 
#' @param D_OPI_CLIMATE (numeric) the opportunity index 
#' @param D_OPI_BIO (numeric) the opportunity index 
#' @param D_OPI_LANDSCAPE (numeric) the opportunity index 
#' @param sector (string) a vector with the farm type given the agricultural sector (options: 'diary', 'arable', 'tree_nursery', 'bulbs')
...
er_meas_score <- function(B_SOILTYPE_AGR, B_GWL_CLASS,  A_P_SG, B_SLOPE, 
                          ...
                          D_OPI_SOIL, D_OPI_WATER, D_OPI_CLIMATE, D_OPI_BIO, D_OPI_LANDSCAPE,
                            measures, sector){
