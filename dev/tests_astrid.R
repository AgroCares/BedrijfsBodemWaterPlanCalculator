...
fieldnr <- 3
field3 <- er_field_scores(B_SOILTYPE_AGR = B_SOILTYPE_AGR[fieldnr], 
                          B_AER_CBS = B_AER_CBS[fieldnr],
                          B_AREA = B_AREA[fieldnr],
                          B_LU_BBWP = B_LU_BBWP[fieldnr],
                          B_LU_ECO1 = B_LU_ECO1[fieldnr],
                          B_LU_ECO2 = B_LU_ECO2[fieldnr], 
                          B_LU_ECO3 = B_LU_ECO3[fieldnr], 
                          B_LU_ECO4 = B_LU_ECO4[fieldnr], 
                          B_LU_ECO5 = B_LU_ECO5[fieldnr], 
                          B_LU_ECO6 = B_LU_ECO6[fieldnr], 
                          B_LU_ECO7 = B_LU_ECO7[fieldnr],
                          B_LU_ECO8 = B_LU_ECO8[fieldnr], 
                          B_LU_ECO9 = B_LU_ECO9[fieldnr],
                          B_LU_ECO10 = B_LU_ECO10[fieldnr],
                          B_CT_SOIL =aim$B_CT_SOIL, 
                          B_CT_WATER = aim$B_CT_WATER,
                          B_CT_CLIMATE = aim$B_CT_CLIMATE,
                          B_CT_BIO = aim$B_CT_BIO,
